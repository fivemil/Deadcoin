...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DEAD");
    case mBTC: return QString("mDEAD");
    case uBTC: return QString::fromUtf8("μDEAD");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Deadcoins"));
    case mBTC: return QString(QObject::tr("Milli-Deadcoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Deadcoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
